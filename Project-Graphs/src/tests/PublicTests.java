...
/*
 * Remove the "block comment" from the code below in order to 
 * "activate" the Public Testing methods. These methods are
 * enclosed in a block comment when this code is shipped to 
 * you in order to allow the submit server to completely compile
